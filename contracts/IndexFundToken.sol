...
import "./ERC20Encryption/ConfidentialERC20WithTransparentErrorsMintableBurnable.sol";
...
contract IndexFundToken is SepoliaZamaFHEVMConfig, ConfidentialERC20WithTransparentErrorsMintableBurnable {
    /// @notice Constructor to initialize the token's name and symbol, and set up the owner
    /// @param name_ The name of the token
    /// @param symbol_ The symbol of the token
    constructor(string memory name_, string memory symbol_)
        ConfidentialERC20WithTransparentErrorsMintableBurnable(name_, symbol_, msg.sender)
    {}
}
