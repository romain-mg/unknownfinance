...
interface IConfidentialERC20 {
     ...
     * @return isSuccess        Whether it succeeds.
     */
    function approve(address spender, euint256 amount) external returns (bool isSuccess);
     ...
     * @return isSuccess    Whether it succeeds.
     */
    function transfer(address to, euint256 amount) external returns (bool isSuccess);
     ...
     * @return isSuccess    Whether it succeeds.
     */
    function transferFrom(address from, address to, euint256 amount) external returns (bool isSuccess);
     ...
     */
    function allowance(address owner, address spender) external view returns (euint256 allowance);
     ...
     */
    function balanceOf(address account) external view returns (euint256 balance);
